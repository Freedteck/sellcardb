...
<motion.div
  ...
  className="fixed inset-0 sm:inset-auto right-0 top-0 bottom-0 w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl bg-white dark:bg-gray-900 z-50 shadow-2xl sm:right-4 sm:top-4 sm:bottom-4 sm:rounded-2xl flex flex-col"
>
